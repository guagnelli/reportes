...
class grocery_CRUD_Model  extends CI_Model  {
    ...
    function get_list()
    {
        ...
        $real_db_prefix = $this->db->dbprefix;// modificado para arreglar dbprefix eddy
        $this->db->set_dbprefix('');//modificado para arreglar dbprefix eddy
    	$results = $this->db->get($this->table_name)->result();
        $this->db->set_dbprefix($real_db_prefix);//modificado para arreglar dbprefix eddy
    	return $results;
    }
    ...
    public function get_row($table_name = null)
    {
       ...
       $table_name = $table_name === null ? $this->table_name : $this->db->dbprefix($table_name);//modificado para arreglar dbprefix eddy        
    ...
    protected function relation_n_n_queries($select)
    {
    	...
    	foreach($this->relation_n_n as $relation_n_n)
    	{
    		list($field_name, $relation_table, $selection_table, $primary_key_alias_to_this_table,
                ...
                $relation_table = $this->db->dbprefix($relation_table);//modificado para arreglar dbprefix eddy
                $selection_table = $this->db->dbprefix($selection_table);//modificado para arreglar dbprefix eddy
                //modificado para arreglar dbprefix eddy
    ...
    {
    	//if( !($this->db->table_exists($table_name)) )//modificado para arreglar dbprefix eddy
