...
class Pdfv extends FPDF
{
    ...
    function Footer()
    {
		...
		$this->Cell(140,11.6,'Generado por: '.$nombreUser,0,0,'L');
		
        //Fecha
		$hoy = getdate();
		$Meses=array('1'=>'Enero', '2'=>'Febrero', '3'=>'Marzo','4'=>'Abril', '5'=>'Mayo', '6'=>'Junio','7'=>'Julio','8'=>'Agosto','9'=>'Septiembre','10'=>'Octubre','11'=>'Noviembre','12'=>'Diciembre');
        $this->SetXY(155,-15.6);
		$this->Cell(50,11.6,$hoy['mday'].'/'.$Meses[$hoy['mon']].'/'.$hoy['year'],0,0,'R');
    }
    ...
    {
        $this->cabeceraHorizontal($cabeceraHorizontal,95);
